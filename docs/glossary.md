...
| ## 会話の駆動             | セッション / セッション駆動 / ターン / speak ツール / remember ツール / forget ツール / keep ツール / index ツール / recall ツール / 覚えたこと / 雑談の要約 / 雑談のアーカイブ / 雑談の索引 / 圧縮の区切り / 許可プロンプト / transcript / セッションスラッグ / 発話                                     |
