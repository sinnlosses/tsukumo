...
| ## 会話の駆動             | セッション / セッション駆動 / ターン / speak ツール / remember ツール / forget ツール / keep ツール / 覚えたこと / 雑談の要約 / 雑談のアーカイブ / 圧縮の区切り / 許可プロンプト / transcript / セッションスラッグ / 発話 |
...
- **注記**: 写しを持つのは**新しいセッションへ記憶を渡すため**で、載せ直すのは雑談のセッションの
  ...
  **「別の場所に複製しない」に対して認められた例外の1つ**（もう1つは下の「雑談のアーカイブ」。
  `docs/requirements.md` 4.9、形と上限は `docs/design.md` 7章）
...
- **注記**: **「別の場所に複製しない」に認められた例外の2つ目**（範囲は
