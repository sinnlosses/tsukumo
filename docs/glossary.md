...
| ## 会話の駆動             | セッション / セッション駆動 / プラン / コンテキストの内訳 / ターン / 背景のタスク / speak ツール / report ツール / remember ツール / forget ツール / keep ツール / index ツール / recall ツール / 覚えたこと / 雑談の要約 / 最近の話題 / 雑談のアーカイブ / 雑談の索引 / 圧縮の区切り / 許可プロンプト / transcript / セッションスラッグ / 発話 / 見直し / 見直しの段 / 提案 / usage_review_stage ツール / usage_review_result ツール / 見送り / 前回の見直し |
