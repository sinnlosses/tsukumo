...
| ## 会話の駆動             | セッション / セッション駆動 / プラン / 利用上限 / コンテキストの内訳 / ターン / ターンの失敗 / 背景のタスク / speak ツール / report ツール / remember ツール / forget ツール / keep ツール / index ツール / recall ツール / 覚えたこと / 雑談の要約 / 最近の話題 / 雑談のアーカイブ / 雑談の索引 / 圧縮の区切り / 許可プロンプト / transcript / セッションスラッグ / 発話 / 見直し / 見直しの段 / 提案 / usage_review_stage ツール / usage_review_result ツール / 見送り / 前回の見直し |
| ## 表示                   | ビュー / 画面 / キャラクター画面 / メインビュー / キャラビュー / ビューサーバ / 立ち絵 / 顔 / プロフィールの札 / ひとことプロフィール / 利用者の呼び名 / ミニ立ち絵の呼び名 / 吹き出し / セリフのログ / セリフ / 詳細 / 最終レポート / 中間レポート / お願い / 選択肢の比較 / 表情 / 衣装 / 書いている / 覆い / いまの作業 / 依頼の手順 / 成果 / 成果の振り返り / キャラクター定義 / フォールバック                                                                                     |
...
- **定義**: 成果の画面のボタンから送る1ターンの依頼。画面に出している数とタスクの一覧を渡し、
  キャラクターに `speak` で感想を言ってもらう
- **注記**: 画面を開いただけでは送らない。雑談のときも送れる
