...
| ## 会話の駆動             | セッション / セッション駆動 / プラン / コンテキストの内訳 / ターン / speak ツール / report ツール / remember ツール / forget ツール / keep ツール / index ツール / recall ツール / 覚えたこと / 雑談の要約 / 最近の話題 / 雑談のアーカイブ / 雑談の索引 / 圧縮の区切り / 許可プロンプト / transcript / セッションスラッグ / 発話 |
...
- **定義**: 帯のまん中に出す、tsukumo がいま何をしているかの札。状態の語（作業中 / 答え待ち /
  依頼待ち / 止まっている）と、実行中の手順の1行の要約を並べる。押すと**依頼の手順**の一覧が
