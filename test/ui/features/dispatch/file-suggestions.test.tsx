...
} from "../../../../src/ui/features/dispatch/file-suggestions.tsx"
...
describe("matchingFilePaths", () => {
  it("前方一致を先に、続けて部分一致を出す", () => {
    expect(matchingFilePaths(PATHS, "src/ui/fe")).toEqual([
      "src/ui/features/dispatch/composer.tsx",
      "src/ui/features/dispatch/file-suggestions.tsx",
    ])
  })
  ...
  it("パスの途中に含むだけでも候補になる（部分一致）", () => {
    expect(matchingFilePaths(PATHS, "composer")).toEqual(["src/ui/features/dispatch/composer.tsx"])
  })
