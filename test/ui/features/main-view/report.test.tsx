...
// （素の `bun test` だと `test/ui/report/markdown.test.tsx` が代役の `Markdown` を見て10件落ちる。
...
mock.module("../../../../src/ui/features/main-view/markdown/markdown.tsx", () => ({
...
const { Report } = await import("../../../../src/ui/features/main-view/report.tsx")
