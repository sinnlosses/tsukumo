...
// （理由は `test/browser/components/page/conversation/main-view/report.test.tsx` の冒頭）。
let revealed: {
...
mock.module(
  "../../../../../../src/browser/components/page/conversation/main-view/report.tsx",
  () => ({
...
const { Turn } =
  await import("../../../../../../src/browser/components/page/conversation/main-view/turn.tsx")
