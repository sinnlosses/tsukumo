...
// （素の `bun test` だと `test/browser/components/page/conversation/main-view/markdown/markdown.test.tsx` が代役の `Markdown` を見て10件落ちる。
...
mock.module(
  "../../../../../../src/browser/components/page/conversation/main-view/markdown/markdown.tsx",
  () => ({
...
const { Report } =
  await import("../../../../../../src/browser/components/page/conversation/main-view/report.tsx")
