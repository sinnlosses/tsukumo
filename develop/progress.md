...
- **ヘッダーの歯車は置き場所だけ空けてある**（2026-09-23。モック `docs/history/mockup/header-2026-09-23.png` にあるが、ユーザーが「設定の画面を新しく作るが、デザインは考え中」と答えたのでタスクにしていない）。設定の画面のデザインが決まったら、歯車と設定の画面を一緒にタスク化する
