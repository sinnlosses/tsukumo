...
最終更新: 2026-09-12（`/plan-tasks` で補完の改善を T-050〜T-052 に起こし、progress.md の
2026-09-11 分を `docs/history/progress-archive.md` へ移した。2026-09-11 に方針を全面的に見直して
...
- **T-020（opus、着手可能）**: レポート構造の規約。出力スタイル（グローバル設定）を触るので承認が要る
...
T-020 / T-042 / T-046 / T-048 はユーザーがいるセッションで。
