...
// （`commandSuggestions(state)`。旧の GET の経路で毎回取りに行く fetch は無くなった —
...
// キー操作（上下・Tab・Enter・Esc）と確定・送信の判断は呼び出し側（`composer.tsx`）が持つ
 ...
 * の中で `position: absolute` の重ねポップアップになる。src/ui/style/dispatch.css）。
 */
