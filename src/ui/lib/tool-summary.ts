...
// （`src/ui/features/sidebar/activity.tsx`）と入力欄の答え待ちの箱
// （`src/ui/features/dispatch/pending-answer.tsx`）の両方が読む**ので、機能をまたぐ道具として
// `ui/lib/` に置く（docs/design.md 2章「`src/ui/` の箱と、置く基準」）。
//
