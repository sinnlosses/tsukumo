...
// （2026-09-20）で、こちらは明確に小さく・半透明にして見分ける。`<Portrait>`（矩形を描く
// 部品）は共有するが、**4つの動き（呼吸・待っている間の移動・完了の反応・失敗でびくっ）は
...
/**
 * 筆先の**右・行の下端**に立たせる（いま書いている行と同じ高さで、書き進む先の側。
 * 2026-09-20 のユーザーの決定）。図・グラフの塊では筆先が塊の左端と上下端になるので、
 * そのまま塊の左端の脇に立つ。
 *
