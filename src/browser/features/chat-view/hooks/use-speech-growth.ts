// 雑談のログで、**末尾のセリフが育つ**見せ方（docs/screen-design.md 13.7「末尾のセリフは育つ」）。
//
...
//
// **仕事のときのレポート（`features/main-view/reveal/use-report-reveal.ts`）とは作りが逆**: あちらは
...
//
// **育てるかどうかはマウントした時点で決まる**（レポートの演出と同じ）。あとから最新で
