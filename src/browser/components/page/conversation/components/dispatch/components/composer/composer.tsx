// 入力欄本体（<Composer>。docs/design.md 6.1）の入口。下書き・補完の候補と選択位置・添えた
...
//
// `/` と `@` の絞り方は `command-suggestions.tsx` / `file-suggestions.tsx` にあり、
// キー操作と確定はフックが持つ（送信の Enter と同じ `keydown` を共有するため）。
//
