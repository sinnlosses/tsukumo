// 雑談ビュー（<ChatView>。docs/screen-design.md 13.7）の入口。雑談モードの間だけ、メインビューの
...
// container / presenter）。
//
// 仕事のときのメインビュー（`components/page/conversation/components/main-view/`）とは並びの規則が違うので、部品を分けて
...
//   いる行」に付き、既定では最新のセリフに付いている。遡るのは押したときだけで、行に
