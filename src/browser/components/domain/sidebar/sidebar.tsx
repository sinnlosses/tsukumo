...
// の区画は帯の「いまの作業」へ移した**（`src/browser/components/domain/screen-nav/`。docs/screen-design.md 13.9）。
//
...
// **差し替えを決めるのはこのファイル**で、`components/app/layout.tsx` の `<Layout>` ではない — 下端の帯は両方の
